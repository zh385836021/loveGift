...
public class CategoryStrateryRecyclerViewTopBean {
    ...
    public String toString() {
        return "CategoryStrateryRecyclerViewTopBean{" +
                "code=" + code +
                ", data=" + data +
                ", message='" + message + '\'' +
                '}';
