...
public final class ViewfinderView extends View {
  ...
  public void onDraw(Canvas canvas) {
    ...
    if (resultBitmap != null) {
      ...
      canvas.drawRect(frame.right-5,frame.top,frame.right+1,frame.top+50,paint);

      //左下角
      canvas.drawRect(frame.left, frame.bottom-50,frame.left+5, frame.bottom,paint);
      canvas.drawRect(frame.left, frame.bottom,frame.left+50, frame.bottom+4,paint);

      //右下角
      canvas.drawRect(frame.right-50, frame.bottom-5,frame.right, frame.bottom,paint);
      canvas.drawRect(frame.right, frame.bottom-50,frame.right+5, frame.bottom,paint);
